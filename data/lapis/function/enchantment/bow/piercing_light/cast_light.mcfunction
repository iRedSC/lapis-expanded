...
scoreboard players remove @s lapis.lifetime 2

# execute if score @s lapis.lifetime matches ..375 run particle dust{color:[0.463,0.278,0.827],scale:1} ~ ~ ~ 0 0 0 1 0 force
execute if score @s lapis.lifetime matches ..390 run particle minecraft:ominous_spawning ~ ~ ~ 0 0 0 1 0 force
execute if score @s lapis.lifetime matches ..390 run particle minecraft:trial_spawner_detection_ominous ~ ~ ~ 0 0 0 1 0 force
...
execute positioned ^ ^ ^0.75 if block ~ ~ ~ #lapis:piercing_light if score @s lapis.lifetime matches 1.. run function lapis:enchantment/bow/piercing_light/cast